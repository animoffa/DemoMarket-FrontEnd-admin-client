...
export {default as ProductsClientContainer} from "@ccontainers/productsContainer";
export {default as SidebarClientContainer} from "../containers/sidebarClientContainer";
